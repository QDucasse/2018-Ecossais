...
class TestBorne(unittest.TestCase):
    ...
    def testInit(self):
        ...
        b=Borne(0,p)
        self.assertEquals(str(b.g1),str(GroupeCartes(Carte(1,'A'),Carte(2,'B'),Carte(3,'C'))))
        self.assertEquals(str(b.g2),str(GroupeCartes(Carte(4,'D'),Carte(5,'E'),Carte(6,'F'))))
    ...
    def testPeutComparer(self):
        ...
        self.assertEquals(b.peutComparer(),True)
        
        #Vérification peutComparer dans un cas Faux
        p.tapis[0][0]=Carte(0,'X')
        b=Borne(0,p)
        self.assertEquals(b.peutComparer(),False)
    ...
    def testComparerCondition1(self):
        ...
        self.assertEquals(p.tapis[3][0],'J1')
    ...
    def testComparerCondition2(self):
        ...
        self.assertEquals(p.tapis[3][0],'J2')
